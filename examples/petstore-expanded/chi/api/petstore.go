//go:generate go run dev.azure.com/schwarzit/schwarzit.odj.core/_git/stackit-client-generator.git/cmd/oapi-codegen --config=cfg.yaml ../../petstore-expanded.yaml
