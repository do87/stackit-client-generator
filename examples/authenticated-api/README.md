...
First, we need to configure our [OapiRequestValidator](https://dev.azure.com/schwarzit/schwarzit.odj.core/_git/stackit-client-generator.git/blob/master/pkg/middleware/oapi_validate.go)
