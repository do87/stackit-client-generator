...
type EveryTypeOptional struct {
	...
	DateField            *openapiTypes.Date `json:"date_field,omitempty"`
...
type EveryTypeRequired struct {
	...
	DateField            openapiTypes.Date   `json:"date_field"`
	DateTimeField        time.Time            `json:"date_time_field"`
	DoubleField          float64              `json:"double_field"`
	EmailField           *openapiTypes.Email `json:"email_field,omitempty"`
