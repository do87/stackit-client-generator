//go:generate go run dev.azure.com/schwarzit/schwarzit.odj.core/_git/stackit-client-generator.git/cmd/oapi-codegen --config=server.cfg.yaml ../strict-schema.yaml
//go:generate go run dev.azure.com/schwarzit/schwarzit.odj.core/_git/stackit-client-generator.git/cmd/oapi-codegen --config=types.cfg.yaml ../strict-schema.yaml
