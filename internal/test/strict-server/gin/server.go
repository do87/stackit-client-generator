//go:generate go run github.com/do87/stackit-client-generator/cmd/oapi-codegen --config=server.cfg.yaml ../strict-schema.yaml
//go:generate go run github.com/do87/stackit-client-generator/cmd/oapi-codegen --config=types.cfg.yaml ../strict-schema.yaml
